...
$sql = 'INSERT INTO tobuy_users_table(id, user_name, user_id, password, is_admin, is_deleted, created_at, updated_at) VALUES(NULL, :user_name, :user_id, :password, 0, 0, sysdate(), sysdate())';
